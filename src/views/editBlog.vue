<template>
    <div>
        <div class="container">
            ...
            <el-button class="submit-btn" type="info" @click="handleCancel">取消</el-button>
...
import { getLibraryList,getLabelList,saveArticle,getArticleDetail } from '@/api/editBlog/index'
...
onMounted(()=>{          
    if(route.query.hasOwnProperty("article")){
        loadArticle(route.query.article)
    }
})
//提交表单
    ...
    getArticleDetail(id)
        .then((res:any)=>{
            if(res.data.code == 200){
                ...
                Object.assign(form.labelId,res.data.data.labels)
            }
        })
        .catch((err:any)=>{
        })
